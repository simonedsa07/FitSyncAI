  ...
  return (
    <div>
      ...
      >
        ...
        {streakCount > 0 && (
          <div className="flex items-center gap-2 rounded-full border-2 border-ink bg-[#D85A30]/10 px-4 py-2 text-sm font-extrabold text-coral transition-all hover:scale-105">
            <span>🔥</span>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
        ...
        >
          <Card className="bg-[#7F77DD]/10 border-2 border-ink h-full">
            <div className="flex items-center gap-2 text-xs font-bold uppercase tracking-wide text-[#7F77DD] mb-3">
              <span>🔮</span>
