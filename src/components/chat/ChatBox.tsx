      ...
      <div className="pointer-events-auto w-full max-w-2xl">
        ...
        <AnimatePresence>
          {expanded && messages.length > 0 && (
            ...
            >
              <div className="flex items-center justify-between border-b-2 border-ink bg-accent/20 px-4 py-2">
        ...
        <div className="relative pt-3">
          <span className="absolute left-7 top-0 z-10 rounded-full border-2 border-ink bg-accent px-2 py-0.5 text-[9px] font-bold uppercase tracking-wide text-ink shadow-sm">
            FitSync AI
          </span>
          <div className="flex h-16 items-center gap-4 rounded-full border-2 border-ink bg-white pl-3 pr-3">
            <button
              ...
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full border-2 border-ink bg-accent text-ink hover:-translate-y-0.5 active:translate-y-0 transition-all"
